...
public class Product
{
	...
	{
		this("Product", id, 0, 0, Category.GENERAL,0,0,0,0,0);
	}

	public Product(String name, String id, double price, int stock, Category category,int oneStarRating, int twoStarRating, int threeStarRating, int fourStarRating, int fiveStarRating)
	{
		this.name = name;
		this.id = id;
		this.price = price;
	...
	public void increaseTwoStar(){
		twoStarRating++;
	}

	public void increaseThreeStar(){
		threeStarRating++;
	}

	public void increaseFourStar(){
		fourStarRating++;
	}

	public void increaseFiveStar(){
		fiveStarRating++;
	}
